function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 31/05/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Bessone", time: new Date(2018,4,31,15,57,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"KingPower", time: new Date(2018,5,1,15,45,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
