...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"TheDon", time: new Date(2018,4,8,9,37,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Boriss", time: new Date(2018,4,9,17,29,0,0).getTime() - getUTC(new Date()), location:"Brooklyn",  city: "NY"});
		rawArray.push({name:"_party_poison_", time: new Date(2018,4,9,17,34,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		rawArray.push({name:"rasp", time: new Date(2018,4,9,17,36,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"Mallues", time: new Date(2018,4,10,5,45,0,0).getTime() - getUTC(new Date()), location:"Manhattan",  city: "NY"});
		...
		rawArray.push({name:"Auroria", time: new Date(2018,4,10,13,12,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Sheitan", time: new Date(2018,4,14,11,40,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
