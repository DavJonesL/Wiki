function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 09/06/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Jdjejebdcjckf", time: new Date(2018,5,10,6,53,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Lawrence_Rafey", time: new Date(2018,5,10,9,48,0,0).getTime() - getUTC(new Date()), location:"Brooklyn",  city: "NY"});
