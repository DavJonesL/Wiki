...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Adan_Harris", time: new Date(2018,4,26,20,50,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Smulik", time: new Date(2018,4,26,21,42,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Arnita_Reed", time: new Date(2018,4,26,22,54,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		rawArray.push({name:"ny_yanks", time: new Date(2018,4,26,23,2,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		rawArray.push({name:"Palloz", time: new Date(2018,4,26,23,4,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"PhillipOdwyer", time: new Date(2018,4,26,23,54,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"ClarencePlitt", time: new Date(2018,4,27,4,37,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"Ectoplasm", time: new Date(2018,4,27,10,41,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"_Lizzie_Avilar", time: new Date(2018,4,27,14,30,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"burdsall", time: new Date(2018,4,27,15,2,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
