function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 15/06/2019";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"DT:BobaFett", time: new Date(2019,5,15,23,28,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		...
		rawArray.push({name:"Jameson", time: new Date(2019,5,16,1,55,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		...
		rawArray.push({name:"HeatherCraig", time: new Date(2019,5,16,3,29,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"Troy_Deathwolf", time: new Date(2019,5,16,8,0,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		rawArray.push({name:"edward_evans", time: new Date(2019,5,16,8,10,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		...
		rawArray.push({name:"Tecklenburg", time: new Date(2019,5,16,10,55,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		...
		rawArray.push({name:"Tom_crogan", time: new Date(2019,5,16,13,55,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		...
		rawArray.push({name:"AlicaNo", time: new Date(2019,5,16,15,17,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"Winslow", time: new Date(2019,5,16,17,53,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		rawArray.push({name:"Erin_Provo", time: new Date(2019,5,16,17,56,0,0).getTime() - getUTC(new Date()), location:"12th Street",  city: "DT"});
		rawArray.push({name:"Iona", time: new Date(2019,5,16,18,0,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		rawArray.push({name:"Anthony_Ambler", time: new Date(2019,5,16,19,14,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"LilMomo", time: new Date(2019,5,16,20,18,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		...
		rawArray.push({name:"gabrielmarriott", time: new Date(2019,5,16,21,45,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"Terina_Baird", time: new Date(2019,5,16,22,43,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"Dxnl", time: new Date(2019,5,16,23,36,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		rawArray.push({name:"Rivo", time: new Date(2019,5,17,0,22,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		rawArray.push({name:"Attebery", time: new Date(2019,5,17,0,50,0,0).getTime() - getUTC(new Date()), location:"12th Street",  city: "DT"});
		...
		rawArray.push({name:"Nano", time: new Date(2019,5,17,1,41,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"CecilHenscheid", time: new Date(2019,5,17,3,15,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		rawArray.push({name:"DewayneArnett", time: new Date(2019,5,17,3,17,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		rawArray.push({name:"Tsubada", time: new Date(2019,5,17,4,3,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"DongWebb", time: new Date(2019,5,17,6,7,0,0).getTime() - getUTC(new Date()), location:"12th Street",  city: "DT"});
		...
		rawArray.push({name:"nemo", time: new Date(2019,5,17,8,21,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		rawArray.push({name:"Hiram_Cole", time: new Date(2019,5,17,8,23,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		rawArray.push({name:"MaryellenBuschman", time: new Date(2019,5,17,8,47,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		rawArray.push({name:"Reinaldo_Grimes", time: new Date(2019,5,17,9,1,0,0).getTime() - getUTC(new Date()), location:"Waterfront",  city: "SEA"});
		rawArray.push({name:"TroyGonzalez", time: new Date(2019,5,17,9,4,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		rawArray.push({name:"fredrockymore", time: new Date(2019,5,17,10,12,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		...
		rawArray.push({name:"Kenya", time: new Date(2019,5,17,11,29,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		rawArray.push({name:"Ingmire", time: new Date(2019,5,17,11,29,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		rawArray.push({name:"Shawn", time: new Date(2019,5,17,11,30,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		rawArray.push({name:"StevenRitums", time: new Date(2019,5,17,11,30,0,0).getTime() - getUTC(new Date()), location:"12th Street",  city: "DT"});
		...
		rawArray.push({name:"Scriuner", time: new Date(2019,5,17,13,37,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		rawArray.push({name:"MichaelLong", time: new Date(2019,5,17,14,49,0,0).getTime() - getUTC(new Date()), location:"Paradise",  city: "LV"});
		rawArray.push({name:"BrandonEngelmeyer", time: new Date(2019,5,17,15,35,0,0).getTime() - getUTC(new Date()), location:"12th Street",  city: "DT"});
		...
		rawArray.push({name:"Amy_Shadwick", time: new Date(2019,5,17,17,17,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"Danieleasley", time: new Date(2019,5,17,18,25,0,0).getTime() - getUTC(new Date()), location:"12th Street",  city: "DT"});
		rawArray.push({name:"Patrickgavin", time: new Date(2019,5,17,18,29,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"LV:Oldman", time: new Date(2019,5,17,19,3,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		...
		rawArray.push({name:"Jerome_Dickun", time: new Date(2019,5,17,21,13,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"LV:BelenusTheMighty", time: new Date(2019,5,18,11,2,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
