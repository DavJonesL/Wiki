function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 18/04/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Clintonvercher", time: new Date(2018,3,19,0,59,0,0).getTime() - getUTC(new Date()), location:"Downtown LA",  city: "LA"});
		...
		rawArray.push({name:"Bettie_Campbell", time: new Date(2018,3,19,3,48,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"DuskoBR", time: new Date(2018,3,19,5,14,0,0).getTime() - getUTC(new Date()), location:"Downtown LA",  city: "LA"});
		...
		rawArray.push({name:"Spray", time: new Date(2018,3,19,6,26,0,0).getTime() - getUTC(new Date()), location:"Downtown LA",  city: "LA"});
		...
		rawArray.push({name:"BrandonRubio", time: new Date(2018,3,19,9,57,0,0).getTime() - getUTC(new Date()), location:"Downtown LA",  city: "LA"});
