function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 27/04/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"ClaudiusC91", time: new Date(2018,3,27,19,19,0,0).getTime() - getUTC(new Date()), location:"Brooklyn",  city: "NY"});
		...
		rawArray.push({name:"Vito", time: new Date(2018,3,28,2,11,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"Donehoo", time: new Date(2018,3,28,14,30,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
