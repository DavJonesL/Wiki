...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Rapper_Sjors", time: new Date(2018,4,28,14,1,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		...
		rawArray.push({name:"Michael_Pollman", time: new Date(2018,4,28,17,16,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"Blaney", time: new Date(2018,4,29,7,7,0,0).getTime() - getUTC(new Date()), location:"Downtown LA",  city: "LA"});
		...
		rawArray.push({name:"Rocscar0", time: new Date(2018,4,30,23,12,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
