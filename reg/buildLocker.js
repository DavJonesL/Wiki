function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 19/05/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Lucas", time: new Date(2018,4,20,3,56,0,0).getTime() - getUTC(new Date()), location:"Summerlin",  city: "LV"});
