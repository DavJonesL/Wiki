function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 12/05/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Arkade", time: new Date(2018,4,13,15,43,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"SweetSunshine", time: new Date(2018,4,13,22,2,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"jc63", time: new Date(2018,4,14,3,38,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
