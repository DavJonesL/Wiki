function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 01/05/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Alia", time: new Date(2018,4,2,15,21,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"NewName", time: new Date(2018,4,2,21,47,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
