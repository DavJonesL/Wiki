function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 25/06/2018";
...
function popAllCharsArray() {
  var rawArray = [];
  <!-- Start Here -->
		rawArray.push({name:"Setterland", time: new Date(2018,5,25,14,16,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"Herbert_newby", time: new Date(2018,5,25,20,28,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"Balderas", time: new Date(2018,5,26,1,54,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"carrie1", time: new Date(2018,5,26,5,54,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		rawArray.push({name:"MadgeStonestreet", time: new Date(2018,5,26,6,11,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"Johnnie_freeman_", time: new Date(2018,5,26,9,46,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Floyd_Demling", time: new Date(2018,5,26,11,39,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		rawArray.push({name:"Wolfsta", time: new Date(2018,5,26,12,8,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		...
		rawArray.push({name:"Tiana_Davis", time: new Date(2018,5,26,17,56,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"HAMBO", time: new Date(2018,5,26,19,43,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Pivot", time: new Date(2018,5,26,22,19,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"Macafee", time: new Date(2018,5,26,23,12,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"Margherita_French", time: new Date(2018,5,27,0,40,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"Marvin_Burns", time: new Date(2018,5,27,1,3,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Whatvz", time: new Date(2018,5,27,3,27,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"_Melvinprager", time: new Date(2018,5,27,6,6,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Xen", time: new Date(2018,5,27,8,19,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		...
		rawArray.push({name:"Janine", time: new Date(2018,5,27,10,26,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"hughhilderbrand", time: new Date(2018,5,27,12,43,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		rawArray.push({name:"Kappa", time: new Date(2018,5,27,12,50,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"GeorgeWatson", time: new Date(2018,5,27,14,5,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Thecreaper", time: new Date(2018,5,27,14,25,0,0).getTime() - getUTC(new Date()), location:"Brooklyn",  city: "NY"});
