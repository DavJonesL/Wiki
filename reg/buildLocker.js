function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 15/05/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Rodolfo_Burgess", time: new Date(2018,4,14,19,12,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Charles_Bingham", time: new Date(2018,4,14,23,4,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"CathleenCasas", time: new Date(2018,4,15,0,1,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"justlookin5", time: new Date(2018,4,15,2,20,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		...
		rawArray.push({name:"Pederson", time: new Date(2018,4,15,3,58,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"LeonardRogers", time: new Date(2018,4,15,10,6,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Lashawn_Bittner", time: new Date(2018,4,15,12,44,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		...
		rawArray.push({name:"TomTerry", time: new Date(2018,4,15,16,2,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Violett", time: new Date(2018,4,15,17,8,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		rawArray.push({name:"ToddRehkop", time: new Date(2018,4,15,17,24,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"randyscott", time: new Date(2018,4,15,20,6,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
