function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 08/07/2019";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Nell", time: new Date(2019,6,8,15,47,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		...
		rawArray.push({name:"Mattes", time: new Date(2019,6,8,19,27,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		...
		rawArray.push({name:"Keiko", time: new Date(2019,6,8,20,36,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		...
		rawArray.push({name:"LA:Tapdance", time: new Date(2019,6,8,23,9,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		rawArray.push({name:"Goblin", time: new Date(2019,6,8,23,33,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
		rawArray.push({name:"dorian", time: new Date(2019,6,9,1,4,0,0).getTime() - getUTC(new Date()), location:"Hollywood",  city: "LA"});
		...
		rawArray.push({name:"Charlotte_Nihei", time: new Date(2019,6,9,2,41,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		...
		rawArray.push({name:"cameron", time: new Date(2019,6,9,3,50,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		rawArray.push({name:"DaleDuncan", time: new Date(2019,6,9,4,3,0,0).getTime() - getUTC(new Date()), location:"Summerlin",  city: "LV"});
		rawArray.push({name:"Derrick_albery", time: new Date(2019,6,9,4,20,0,0).getTime() - getUTC(new Date()), location:"Hollywood",  city: "LA"});
		...
		rawArray.push({name:"PatriciaDeterding", time: new Date(2019,6,9,5,29,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		...
		rawArray.push({name:"Evonne_emig", time: new Date(2019,6,9,9,9,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		...
		rawArray.push({name:"Nancy_Barrilleaux", time: new Date(2019,6,9,15,54,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"Marvin_Chandler", time: new Date(2019,6,9,17,23,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"ElvinStoker-", time: new Date(2019,6,9,22,18,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		...
		rawArray.push({name:"AmnesiaHaze", time: new Date(2019,6,10,0,55,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "LA"});
		rawArray.push({name:"Dewey_Birks", time: new Date(2019,6,10,1,45,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"David_Rogers", time: new Date(2019,6,10,3,33,0,0).getTime() - getUTC(new Date()), location:"Hollywood",  city: "LA"});
