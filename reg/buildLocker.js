function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 29/05/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"BigFather", time: new Date(2018,4,29,20,53,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Vincent-Valentine", time: new Date(2018,4,30,1,17,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		...
		rawArray.push({name:"Debra", time: new Date(2018,4,30,6,24,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"Bryan", time: new Date(2018,4,30,9,38,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"albin", time: new Date(2018,4,30,11,53,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Crono", time: new Date(2018,4,30,20,41,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		rawArray.push({name:"Treeza", time: new Date(2018,4,30,20,45,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		...
		rawArray.push({name:"Rocscar0", time: new Date(2018,4,30,23,12,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"BugsySiegal", time: new Date(2018,4,31,19,0,0,0).getTime() - getUTC(new Date()), location:"Bella Vista",  city: "PH"});
		...
		rawArray.push({name:"Scarano", time: new Date(2018,4,31,22,41,0,0).getTime() - getUTC(new Date()), location:"Downtown LA",  city: "LA"});
		...
		rawArray.push({name:"Douglas_Trucks", time: new Date(2018,5,1,2,27,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		rawArray.push({name:"Lauren_Orenstein", time: new Date(2018,5,1,2,28,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Rdk", time: new Date(2018,5,1,16,8,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		rawArray.push({name:"Ashwin", time: new Date(2018,5,1,16,14,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		rawArray.push({name:"reineke", time: new Date(2018,5,1,16,29,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		...
		rawArray.push({name:"Jenaye", time: new Date(2018,5,1,18,38,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		rawArray.push({name:"VeroniqueGarrison", time: new Date(2018,5,1,18,40,0,0).getTime() - getUTC(new Date()), location:"Ballard",  city: "SEA"});
		...
		rawArray.push({name:"Thomason", time: new Date(2018,5,1,19,35,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"Oliveira", time: new Date(2018,5,1,20,45,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		rawArray.push({name:"CalliopeTorres", time: new Date(2018,5,1,21,12,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"RayPerry", time: new Date(2018,5,1,21,47,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"LaurenDeblasio", time: new Date(2018,5,1,23,4,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"Eleonore_Maupins", time: new Date(2018,5,1,23,14,0,0).getTime() - getUTC(new Date()), location:"Ballard",  city: "SEA"});
		...
		rawArray.push({name:"Eura", time: new Date(2018,5,2,0,34,0,0).getTime() - getUTC(new Date()), location:"Ballard",  city: "SEA"});
		rawArray.push({name:"A-t-H-e-N-a", time: new Date(2018,5,2,1,1,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Manie_Billingsley", time: new Date(2018,5,2,2,6,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		rawArray.push({name:"BadBoy289", time: new Date(2018,5,2,2,37,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		rawArray.push({name:"IllMac", time: new Date(2018,5,2,3,4,0,0).getTime() - getUTC(new Date()), location:"Pioneer Square",  city: "SEA"});
		rawArray.push({name:"Hisako", time: new Date(2018,5,2,4,36,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
