function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 06/06/2019";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"CH:Valkorion", time: new Date(2019,5,6,14,25,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		...
		rawArray.push({name:"LV:Bluntman", time: new Date(2019,5,7,22,55,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		...
		rawArray.push({name:"ORAN", time: new Date(2019,5,11,6,48,0,0).getTime() - getUTC(new Date()), location:"Paradise",  city: "LV"});
		rawArray.push({name:"Alverest", time: new Date(2019,5,11,11,28,0,0).getTime() - getUTC(new Date()), location:"Paradise",  city: "LV"});
		rawArray.push({name:"Lakesha", time: new Date(2019,5,11,12,35,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		rawArray.push({name:"FreddyEdes", time: new Date(2019,5,11,19,3,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		rawArray.push({name:"ridgeway", time: new Date(2019,5,11,23,48,0,0).getTime() - getUTC(new Date()), location:"Summerlin",  city: "LV"});
		rawArray.push({name:"JovanStopa_", time: new Date(2019,5,11,23,49,0,0).getTime() - getUTC(new Date()), location:"Paradise",  city: "LV"});
		rawArray.push({name:"carolynmiller", time: new Date(2019,5,12,1,36,0,0).getTime() - getUTC(new Date()), location:"Summerlin",  city: "LV"});
		rawArray.push({name:"KenFerguson", time: new Date(2019,5,12,3,19,0,0).getTime() - getUTC(new Date()), location:"Summerlin",  city: "LV"});
		rawArray.push({name:"LawrenceClair", time: new Date(2019,5,12,4,26,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		rawArray.push({name:"Duncan_Hinebaugh", time: new Date(2019,5,12,6,15,0,0).getTime() - getUTC(new Date()), location:"Paradise",  city: "LV"});
		rawArray.push({name:"SteveMurillo", time: new Date(2019,5,12,8,7,0,0).getTime() - getUTC(new Date()), location:"The Strip",  city: "LV"});
		rawArray.push({name:"calista", time: new Date(2019,5,12,10,33,0,0).getTime() - getUTC(new Date()), location:"Paradise",  city: "LV"});
		rawArray.push({name:"JimThai", time: new Date(2019,5,12,14,16,0,0).getTime() - getUTC(new Date()), location:"Paradise",  city: "LV"});
<!-- End Here -->
  return rawArray;
}
