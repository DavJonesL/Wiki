function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 22/06/2019";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Atlas", time: new Date(2019,5,22,18,31,0,0).getTime() - getUTC(new Date()), location:"Pasadena",  city: "LA"});
		...
		rawArray.push({name:"Waffle", time: new Date(2019,5,22,21,11,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Loserskillnewbs", time: new Date(2019,5,22,22,16,0,0).getTime() - getUTC(new Date()), location:"Brooklyn",  city: "NY"});
		...
		rawArray.push({name:"JoeyNoLegs", time: new Date(2019,5,23,3,16,0,0).getTime() - getUTC(new Date()), location:"Bricktown",  city: "DT"});
