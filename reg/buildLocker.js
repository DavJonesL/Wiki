function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 20/06/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Mouldy", time: new Date(2018,5,20,10,2,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"Horace_Mull", time: new Date(2018,5,20,14,1,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"DustinLaver", time: new Date(2018,5,20,17,14,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"Linc", time: new Date(2018,5,20,18,45,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"Jeffrenfroe", time: new Date(2018,5,20,23,40,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"Kristy_douma_", time: new Date(2018,5,21,2,30,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"Mottern", time: new Date(2018,5,21,4,10,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"Gaviria", time: new Date(2018,5,21,11,12,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"mccoy", time: new Date(2018,5,21,21,23,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		...
		rawArray.push({name:"Alma_murchison", time: new Date(2018,5,22,12,47,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
		...
		rawArray.push({name:"Forums2", time: new Date(2018,5,26,22,19,0,0).getTime() - getUTC(new Date()), location:"The Loop",  city: "CH"});
<!-- End Here -->
  return rawArray;
}
