...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"driedric", time: new Date(2018,10,26,6,11,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		...
		rawArray.push({name:"Dichiara", time: new Date(2018,10,26,10,42,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Clayton_click", time: new Date(2018,10,26,13,25,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		rawArray.push({name:"Demarcus", time: new Date(2018,10,26,13,34,0,0).getTime() - getUTC(new Date()), location:"South Side",  city: "CH"});
		rawArray.push({name:"Don_Lahey", time: new Date(2018,10,26,14,2,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		...
		rawArray.push({name:"g00dfit3m8", time: new Date(2018,10,27,1,50,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		rawArray.push({name:"nanette_joseph", time: new Date(2018,10,27,2,23,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Fng", time: new Date(2018,10,27,5,19,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Amphitrite", time: new Date(2018,10,27,8,59,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		rawArray.push({name:"YeyoEnMiAndroid", time: new Date(2018,10,27,9,40,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"Glenn_Kneisler", time: new Date(2018,10,27,16,37,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		...
		rawArray.push({name:"GerryBoniface", time: new Date(2018,10,27,19,38,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		rawArray.push({name:"AmericoRJ", time: new Date(2018,10,27,19,58,0,0).getTime() - getUTC(new Date()), location:"Corktown",  city: "DT"});
		...
		rawArray.push({name:"david_fluet", time: new Date(2018,10,27,21,59,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"FaustinoDenoon", time: new Date(2018,10,27,22,43,0,0).getTime() - getUTC(new Date()), location:"Downtown",  city: "DT"});
		...
		rawArray.push({name:"The_Crow", time: new Date(2018,10,28,0,4,0,0).getTime() - getUTC(new Date()), location:"Old City District",  city: "PH"});
		...
		rawArray.push({name:"Lilsweetie", time: new Date(2018,10,28,1,7,0,0).getTime() - getUTC(new Date()), location:"12th Street",  city: "DT"});
