function buildPage(){
  document.getElementById("lastUpdateP").innerHTML = "<b>Last Update</b> 27/05/2018";
...
function popAllCharsArray() {
  ...
  <!-- Start Here -->
		...
		rawArray.push({name:"Clyde_Clem", time: new Date(2018,4,27,11,37,0,0).getTime() - getUTC(new Date()), location:"Brooklyn",  city: "NY"});
		...
		rawArray.push({name:"JohnnyDepp", time: new Date(2018,4,27,13,3,0,0).getTime() - getUTC(new Date()), location:"Brooklyn",  city: "NY"});
		...
		rawArray.push({name:"Veasley", time: new Date(2018,4,27,15,44,0,0).getTime() - getUTC(new Date()), location:"Manhattan",  city: "NY"});
